    ...
    return (
        <div>
            ...
            <div className='w-full p-[24px] shadow-lightmode  dark:shadow-customshadow mt-5 rounded-lg'>
                ...
                <input ref={amountref} onKeyDown={(e) => e.key == 'Enter' && (handlingAdd(), nameref.current.focus())} className='w-full mt-2 focus:outline-none bg-transparent shadow-lightmodeclick dark:shadow-buttonclick p-[5px_10px] rounded-md' type='number' />
                <button onChange={handlingAdd} className='min-h-[50px] shadow-lightmode  dark:shadow-customshadow w-full px-10 mt-5 rounded-lg text-white font-bold active:shadow-lightmodeclick  dark:active:shadow-buttonclick'>
                    Add
                </button>
            </div>
